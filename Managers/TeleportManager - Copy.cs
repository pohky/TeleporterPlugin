...
//        internal static void ChangeLanguage(TeleporterLanguage lang, DalamudPluginInterface plugin) {
//            if (lang == TeleporterLanguage.Client)
//                CurrentLanguage = plugin.ClientState.ClientLanguage;
//            else CurrentLanguage = (ClientLanguage)lang;
//            InitData(plugin);
//        }
